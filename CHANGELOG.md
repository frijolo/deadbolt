...
- **Clipboard auto-clear for secrets** — Copying a seed phrase, WIF, or xprv now automatically overwrites the clipboard after 30 seconds. On Android 13+, the clipboard entry is also marked `IS_SENSITIVE` to suppress it from keyboard suggestions and clipboard history overlays.
